...
public class ManagementResource extends AbstractContextResource {
	...
	public Response getAccessToken(
			...
			@QueryParam("service") @DefaultValue(DEFAULT_SERVICE_URL) String service,
	...
	public Response getAccessTokenPost(
			@Context UriInfo ui,
		...
		return getAccessToken(ui, null, grant_type, ticket, service, username,
				password, client_id, client_secret, ttl, callback);
	}

	@POST
	@Path("token")
	@Consumes(APPLICATION_JSON)
	public Response getAccessTokenPostJson(
			@Context UriInfo ui,
